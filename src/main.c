...
/*   Updated: 2023/11/03 09:42:59 by nbiron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	headings(1);
	v_printf = printf("%u", 2147483647);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%u", 2147483647);
	bn();
	...
	headings(1);
	v_printf = printf("%i", 2147483647);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%i", 2147483647);
	...
	headings(1);
	v_printf = printf("%i", -2147483648);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%i", -2147483648);
	...
	headings(1);
	v_printf = printf("%x", 2147483647);
	bn();
	headings(2);
	v_ftprintf = ft_printf("%x", 2147483647);
